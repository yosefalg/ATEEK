...
patch('src/components/SpatialDealScreens.tsx', [
  ...
  ['reference card fixed height', "  contextBanner: { marginHorizontal: 10, marginBottom: 5, borderRadius: 18, borderWidth: 1, borderColor: LINE, backgroundColor: '#11151D', padding: 9, flexDirection: 'row-reverse', alignItems: 'center', gap: 10 },", "  contextBanner: { marginHorizontal: 10, marginBottom: 5, height: 56, minHeight: 56, maxHeight: 56, overflow: 'hidden', borderRadius: 18, borderWidth: 1, borderColor: LINE, backgroundColor: '#11151D', paddingHorizontal: 9, flexDirection: 'row-reverse', alignItems: 'center', gap: 10 },"],
