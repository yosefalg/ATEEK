...
const s=StyleSheet.create({
  ...
  buildInfo:{backgroundColor:colors.forest,borderRadius:20,padding:18,borderWidth:1,borderColor:colors.gold,gap:7},buildInfoTitle:{color:colors.gold,fontSize:18,fontWeight:'900',textAlign:'right'},buildInfoText:{color:colors.goldSoft,fontSize:16,fontWeight:'900',textAlign:'center'},buildInfoHint:{color:colors.goldSoft,fontSize:11,textAlign:'right',lineHeight:20}
});