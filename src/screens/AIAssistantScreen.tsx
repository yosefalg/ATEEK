...
const s = StyleSheet.create({
  ...
  modeList:{flexGrow:0,maxHeight:62},modes:{paddingHorizontal:12,paddingVertical:9,gap:8},modeChip:{minHeight:44,borderRadius:14,borderWidth:1,paddingHorizontal:12,flexDirection:'row-reverse',alignItems:'center',gap:6},modeText:{fontSize:11,fontWeight:'800'},
  messages:{padding:14,paddingBottom:20,gap:10},emptyMessages:{flexGrow:1,justifyContent:'center',padding:24},bubble:{maxWidth:'89%',borderRadius:20,borderWidth:1,padding:13,gap:7},userBubble:{alignSelf:'flex-end',borderBottomRightRadius:7},aiBubble:{alignSelf:'flex-start',borderBottomLeftRadius:7},aiLabel:{flexDirection:'row-reverse',alignItems:'center',alignSelf:'flex-end',gap:5},aiLabelText:{fontSize:10,fontWeight:'900'},body:{fontSize:14,lineHeight:22,textAlign:'right',writingDirection:'rtl'},typing:{minHeight:28,flexDirection:'row-reverse',alignItems:'center',gap:8},typingText:{fontSize:11,fontWeight:'700'},share:{minHeight:44,alignSelf:'flex-start',flexDirection:'row-reverse',alignItems:'center',gap:5,paddingHorizontal:8},shareText:{fontSize:10,fontWeight:'700'},
